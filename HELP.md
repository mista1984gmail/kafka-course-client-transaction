...
* The original package name 'com.example.kafka-course-client-transaction' is invalid and this project uses 'com.example.kafkacourseclienttransaction' instead.
